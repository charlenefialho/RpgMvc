...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://localhost:5000/RpgApi/PersonagemHabilidades/";


        [HttpGet("Personagemgabilidades/{id}")]
        public async Task<ActionResult> DeteleAsync(int id)
        {
            try
            {
